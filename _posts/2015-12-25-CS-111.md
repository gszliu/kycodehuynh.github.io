...
Below are my notes from CS 111 during the Winter 2014
...
// LOL at the last lecture before us in this room: 
// "No class for EE115B this week. Please try HW#0"
 
// This room is small! And the desks suck! 

// Eggert looks taller from this angle (the seats are low in the ground)

// Way too many people in this room. Eggert is trying
// for a bigger room, but people can't be added if no room is found

// I guess we're going to 131 tomorrow

// We have more people enrolled than there are seats in this class
