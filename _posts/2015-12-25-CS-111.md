...
download this page's [Markdown version](https://raw.githubusercontent.com/KyCodeHuynh/kycodehuynh.github.io/master/_posts/2015-12-25-CS-111.md)
...
- [Lecture #1: 5 January 2014][lecture-1-5-january-2014]
    - [Magical Grep][magical-grep]
    - [Course Administration][course-administration]
    - [Operating Systems][operating-systems]
        - [Definition: System][definition-system]
    - [Problems in System Design][problems-in-system-design]
- [Lecture #2: 7 January 2015][lecture-2-7-january-2015]
    - [(Very) Paranoid Word Counter][very-paranoid-word-counter]
    - [Boot Sequence][boot-sequence]
    - [How hard disks work][how-hard-disks-work]
    - [How to read from disk][how-to-read-from-disk]
- [Discussion #1: 9 January 2015][discussion-1-9-january-2015]
    - [Lab 1a Problem Description][lab-1a-problem-description]
    - [Skeleton Code for 1a][skeleton-code-for-1a]
        - [alloc.c][allocc]
        - [alloc.h][alloch]
        - [main.c][mainc]
        - [read_command.c][read_commandc]
        - [test-t-bad and test-t-ok][test-t-bad-and-test-t-ok]
        - [print_command.c][print_commandc]
        - [Discussion with Taqi][discussion-with-taqi]
- [Lecture #3: 12 January 2015][lecture-3-12-january-2015]
    - [Improvements to VPWC][improvements-to-vpwc]
        - [Double buffering][double-buffering]
        - [Increase buffer size][increase-buffer-size]
        - [DMA: Direct Memory Access][dma-direct-memory-access]
    - [Problems with Growing Our Program][problems-with-growing-our-program]
    - [Modularity and Abstraction][modularity-and-abstraction]
    - [Improving read_ide_sector()][improving-read_ide_sector]
    - [How to implement modularity][how-to-implement-modularity]
        - [Recursive function example][recursive-function-example]
        - [Soft vs. Hard Modularity][soft-vs-hard-modularity]
    - [dump][dump]
- [Lecture #4: 14 January 2015][lecture-4-14-january-2015]
    - [Hard modularity][hard-modularity]
        - [Virtualization][virtualization]
        - [SYSENTER & SYSEXIT][sysenter--sysexit]
        - [VDSO][vdso]
        - [][]
    - [Processes][processes]
    ...
    - [dump][dump-1]
- [Discussion #2: 16 January 2015][discussion-2-16-january-2015]
    - [Hints on Lab 1b][hints-on-lab-1b]
        - [execlp][execlp]
        - [fork][fork]
        - [dup2][dup2]
        - [pipe][pipe]
        - [if, until, and while commands][if-until-and-while-commands]
    - [WeensyOS 1][weensyos-1]
- [Lecture #5: 19 January 2015][lecture-5-19-january-2015]
    - [Orthogonality][orthogonality]
        - [Access to files (and devices)][access-to-files-and-devices]
            - [Device Types:][device-types]
        - [Access to Processes][access-to-processes]
    - [Modeling OS resources in a program][modeling-os-resources-in-a-program]
        - [Redirection][redirection]
    - [Piping][piping]
        - [Piping Issues][piping-issues]
    - [dump][dump-2]
- [Discussion #3: 23 January 2015][discussion-3-23-january-2015]
    - [Lab 1c][lab-1c]
        - [clock_gettime()][clock_gettime]
        - [Execution time clock choice][execution-time-clock-choice]
        - [clock_getres()][clock_getres]
        - [getrusage()][getrusage]
        - [Additional][additional]
        - [Where to start][where-to-start]
    - [dump][dump-3]
- [Lecture #6: 26 January 2015][lecture-6-26-january-2015]
    - [Orthogonality and Trouble][orthogonality-and-trouble]
        - [I/O on an Unlinked File][io-on-an-unlinked-file]
        - [Unlinked Flash Drive][unlinked-flash-drive]
        - [Zombie Processes][zombie-processes]
    - [Named Temporary File with Race Condition][named-temporary-file-with-race-condition]
    - [Example with gzip][example-with-gzip]
    - [Signals][signals]
        - [signal() system call][signal-system-call]
        - [Signal Masks][signal-masks]
        - [Critical Sections][critical-sections]
        - [Side Effects of Signal Handlers][side-effects-of-signal-handlers]
        - [Reasons for Signals and a List of Them][reasons-for-signals-and-a-list-of-them]
        - [Asynchronous Signal-Safe Functions][asynchronous-signal-safe-functions]
    - [Threads][threads]
        - [Expensive Resources][expensive-resources]
        - [Cheap Resources][cheap-resources]
    - [dump][dump-4]
- [Lecture #7: 28 January 2015][lecture-7-28-january-2015]
    - [Threads][threads-1]
    - [Scheduling Threads][scheduling-threads]
    - [Scheduling Goals][scheduling-goals]
    - [Scheduling Policies][scheduling-policies]
        - [Real-time Scheduling][real-time-scheduling]
        - [Hard Real-Time Scheduling][hard-real-time-scheduling]
        - [Soft Real-Time Scheduling][soft-real-time-scheduling]
...
- [Discussion #4: 30 January 2015][discussion-4-30-january-2015]
    - [Problem 1][problem-1]
    - [Problem 2][problem-2]
    - [Problem 3][problem-3]
    - [Problem 4][problem-4]
    ...
    - [Problem 7][problem-7]
    - [Problem 8][problem-8]
- [Lecture #8: 2 February 2015][lecture-8-2-february-2015]
    - [Round Robin Scheduling][round-robin-scheduling]
    - [Priority Scheduling][priority-scheduling]
    - [Synchronization][synchronization]
        - [The Issue][the-issue]
        - [Ways to Prevent Race Conditions][ways-to-prevent-race-conditions]
            - [Sequence Coordination][sequence-coordination]
            - [Isolation][isolation]
            - [Atomicity][atomicity]
                - [Kinds of Atomic Actions][kinds-of-atomic-actions]
            - [Cheating Atoms][cheating-atoms]
        - [Example: ATM withdrawal/deposity][example-atm-withdrawaldeposity]
        - [Critical Sections][critical-sections-1]
        - [Pipes in Threads][pipes-in-threads]
            - [Lock Grain][lock-grain]
        - [dump][dump-5]
    - [dump][dump-6]
- [Discussion #5: 6 February 2015][discussion-5-6-february-2015]
    - [Kernel Module][kernel-module]
    - [Code Layout][code-layout]
    - [Spinlock][spinlock]
        - [wait_event_interruptible][wait_event_interruptible]
    - [printk][printk]
- [Lecture #9: 9 February 2015][lecture-9-9-february-2015]
    - [How to implement critical sections][how-to-implement-critical-sections]
        - [Back to lock/unlock][back-to-lockunlock]
        - [Special atomic x86 instructions][special-atomic-x86-instructions]
            - [lock incl][lock-incl]
            - [xchgl][xchgl]
            - [compare_and_swap][compare_and_swap]
        - [Pipe Example][pipe-example]
            - [Blocking Mutex][blocking-mutex]
        - [From TBP Tutoring with Mickey][from-tbp-tutoring-with-mickey]
        - [Summary of Possible Problems][summary-of-possible-problems]
    - [Detour: semaphore][detour-semaphore]
    - [Pipe with Blocking Mutex][pipe-with-blocking-mutex]
    - [Condition Variables][condition-variables]
    - [Read-write lock][read-write-lock]
- [Lecture #10: 11 February 2015][lecture-10-11-february-2015]
    - [Hardware Lock Elision][hardware-lock-elision]
    - [Deadlock][deadlock]
        - [Conditions for Deadlock][conditions-for-deadlock]
            - [Mutual Exclusion][mutual-exclusion]
            - [Circular Wait][circular-wait]
            - [No pre-emption of locks][no-pre-emption-of-locks]
            - [Hold and wait][hold-and-wait]
        - [Solving Deadlock][solving-deadlock]
            - [Detecting Deadlocks Dynamically][detecting-deadlocks-dynamically]
            - [Redesign so that deadlocks cannot occur][redesign-so-that-deadlocks-cannot-occur]
        - [dump][dump-7]
    - [Priority Inversion][priority-inversion]
    - [Livelock][livelock]
    - [Event-driven programming][event-driven-programming]
    - [File Systems Performance][file-systems-performance]
        - [GPFS][gpfs]
            - [Stripe Like Crazy][stripe-like-crazy]
            - [Distributed Metadata][distributed-metadata]
            - [Efficient Directory Indexing][efficient-directory-indexing]
            - [Distributed Locking][distributed-locking]
            - [Partition Awareness][partition-awareness]
        - [dump][dump-8]
    - [I/O Performance][io-performance]
    - [Scheduling and File Systems][scheduling-and-file-systems]
- [Discussion #6: 13 February 2015][discussion-6-13-february-2015]
    - [Building the Disk][building-the-disk]
    - [Superblock][superblock]
    - [Free block bitmap][free-block-bitmap]
    - [allocate_block() and free_block()][allocate_block-and-free_block]
    - [Inode][inode]
        - [Accessing Data from Inode][accessing-data-from-inode]
    - [Data for Directory][data-for-directory]
    - [Hardlink and Symbolic Link][hardlink-and-symbolic-link]
- [Lecture #11: 18 February 2015][lecture-11-18-february-2015]
    - [Disk Scheduling][disk-scheduling]
        - [Shortest Seek Time First][shortest-seek-time-first]
        - [First Come First Serve][first-come-first-serve-1]
        - [SSTF + FCFS][sstf--fcfs]
        - [Elevator Algorithm][elevator-algorithm]
            - [Circular Elevator][circular-elevator]
        - [dump][dump-9]
    - [Anticipatory Scheduling][anticipatory-scheduling]
    - [Concurrent I/O][concurrent-io]
    - [File System Design][file-system-design]
    - [FAT File System][fat-file-system]
    - [UNIX File System][unix-file-system]
    - [Berkeley Fast File System (FFS)][berkeley-fast-file-system-ffs]
- [Discussion #6: 20 February 2015][discussion-6-20-february-2015]
    - [Scheduling][scheduling]
    - [Synchronization][synchronization-1]
    - [Midterm 1 Post-Mortem][midterm-1-post-mortem]
    ...
    - [dump][dump-10]
- [Lecture #12: 23 February 2015][lecture-12-23-february-2015]
    - [Inodes and Indirect Blocks][inodes-and-indirect-blocks]
    - [Wedding Cake Abstraction of File Systems][wedding-cake-abstraction-of-file-systems]
        - [chdir()][chdir]
        - [chroot()][chroot]
        - [chrooted jail][chrooted-jail]
    - [Symbolic Links][symbolic-links]
        - [Symlink Implmenetation][symlink-implmenetation]
        - [lstat()][lstat]
        - [readlink()][readlink]
        - [unlink()][unlink]
    - [Special Files][special-files]
        - [mknod()][mknod]
        - [mkfifo][mkfifo]
    - [Dealing with Low-Level Failures][dealing-with-low-level-failures]
        - [shred][shred]
    - [dump][dump-11]
- [Lecture #13: 25 February 2015][lecture-13-25-february-2015]
    - [Invariants for File Systems][invariants-for-file-systems]
        - [Consequences of Violating Invariants][consequences-of-violating-invariants]
    - [Performance Issues][performance-issues]
        - [Out-of-order Writes][out-of-order-writes]
            ...
            - [rename()][rename]
        - [fsck][fsck]
    - [Interaction Between Scheduling and Robustness][interaction-between-scheduling-and-robustness]
    - [Robustness Terminology and Theory][robustness-terminology-and-theory]
        - [Atomicity][atomicity-1]
            - [Golden Rule of Atomicity][golden-rule-of-atomicity]
            - [Lampson-Sturgis Assumptions][lampson-sturgis-assumptions]
        - [Commit Records][commit-records]
        - [Journaling][journaling]
    - [dump][dump-12]
- [Discussion: 27 February 2015][discussion-27-february-2015]
    - [Final Report Format][final-report-format]
        - [Style Suggestions][style-suggestions]
    - [dump][dump-13]
- [Lecture #14: 2 March 2015][lecture-14-2-march-2015]
    - [Atomic Updates to File Systems][atomic-updates-to-file-systems]
        - [Main Memory Database][main-memory-database]
    - [Write-head log][write-head-log]
    - [Write-behind log][write-behind-log]
        - [Log Approaches Compared][log-approaches-compared]
    - [Increasing Parallelism with Atomicity][increasing-parallelism-with-atomicity]
        - [Cascading Aborts][cascading-aborts]
        - [Compensating Actions][compensating-actions]
    - [Memory Protection][memory-protection]
        - [Base/Bounds][basebounds]
            - [Position Independent Code][position-independent-code]
        - [Segmented Memory: Multiple Base/Bounds Pairs][segmented-memory-multiple-basebounds-pairs]
        - [Paging][paging]
            - [Stack Smashing on Steroids][stack-smashing-on-steroids]
        ...
        - [dump][dump-14]
    - [dump][dump-15]
- [Lecture #15: 4 March 2015][lecture-15-4-march-2015]
    - [Review: Page Replacement Mechanism][review-page-replacement-mechanism]
    - [Page Replacement Policy][page-replacement-policy]
        - [Comparing Policies][comparing-policies]
        - [FIFO][fifo]
        - [LRU][lru]
        - [Oracle][oracle]
    - [Paging Optimization][paging-optimization]
        ...
        - [Dirty Bit][dirty-bit]
            - [fork() Optimization][fork-optimization]
            - [vfork()][vfork]
        - [dump][dump-16]
    - [malloc() Implementation][malloc-implementation]
        - [mmap()][mmap]
    - [Apache][apache]
    - [Distributed Systems and RPC][distributed-systems-and-rpc]
        - [RPC (Remote Procedure Call) vs. Syscall][rpc-remote-procedure-call-vs-syscall]
            - [Marshalling (serialization/pickling)][marshalling-serializationpickling]
        - [dump][dump-17]
    - [dump][dump-18]
- [Discussion: 6 March 2015][discussion-6-march-2015]
    - [Lab 4][lab-4]
    - [Linux network working socket layer user interface][linux-network-working-socket-layer-user-interface]
        - [socket()][socket]
        - [bind()][bind]
        - [listen()][listen]
        - [accept()][accept]
    ...
    - [Scalability and Security][scalability-and-security]
        - [Parallelizing Downloads/Uploads][parallelizing-downloadsuploads]
        - [Buffer Overflow][buffer-overflow]
        - [Permissions][permissions]
    - [dump][dump-19]
- [Lecture #16: 9 March 2015][lecture-16-9-march-2015]
    - [Media Faults][media-faults]
        - [Flash drive problems][flash-drive-problems]
        - [RAID][raid]
            - [Hardware RAID vs Software RAID][hardware-raid-vs-software-raid]
            - [RAID Robustness][raid-robustness]
        - [dump][dump-20]
    - [RPC Failure Modes][rpc-failure-modes]
        - [HTTP][http]
        ...
        - [dump][dump-21]
    - [dump][dump-22]
- [Lecture #17: 11 March 2015][lecture-17-11-march-2015]
    - [Security][security]
    - [Main Forms of Attacks][main-forms-of-attacks]
    - [General Goals][general-goals]
        - [Security Testing][security-testing]
    - [Threat Modeling and Classification][threat-modeling-and-classification]
    - [General OS Security Functions][general-os-security-functions]
        - [Authentication][authentication]
            - [Attacking Passwords][attacking-passwords]
            - [External and Internal Authentication][external-and-internal-authentication]
        - [Integrity][integrity]
        - [Authorization][authorization]
            - [Methods of Access][methods-of-access]
            - [Access Control Lists (ACLs)][access-control-lists-acls]
            - [Capabilities][capabilities]
        - [Auditing][auditing]
        - [Correctness][correctness]
    - [Trusted Computing Base (Kerckhoff's Design Principle)][trusted-computing-base-kerckhoffs-design-principle]
- [Discussion: 13 March 2015][discussion-13-march-2015]
...
We have yet to write cws() or display_ans()! 
    ...
    int cws(char* buf, int bufsize, bool* inword)
    {
        ...
        for (int i = 0; i < bufsize; i++) {
            ...
            bool alpha = isalpha((unsigned char)bug[i]);
