...
- [Lecture 1: 6 January 2014][lecture-1-6-january-2014]
    - [A Little About Carey][a-little-about-carey]
    - [Thoughts on Teaching][thoughts-on-teaching]
    - [Time for CS][time-for-cs]
    - [Algorithms][algorithms]
        ...
        - [C++ Review][c-review]
            ...
            - [C++ Classes][c-classes]
        - [Dump][dump]
    - [Lecture 2: 8 January 2014][lecture-2-8-january-2014]
        - [C++ Classes Review][c-classes-review]
            - [Constructors][constructors]
            - [Default Parameters][default-parameters]
            - [Overloading Constructors][overloading-constructors]
            - [Initializer Lists][initializer-lists]
            - [When Constuctors are Called][when-constuctors-are-called]
            - [Destructors][destructors]
        - [Class Composition][class-composition]
        - [Initializer List][initializer-list]
            - [Construction Order][construction-order]
            - [Destruction Order][destruction-order]
        - [Advanced Class Composition][advanced-class-composition]
        - [#include Directives][include-directives]
            - [#include Guards][include-guards]
            - [Include Etiquette][include-etiquette]
                - [When to #include][when-to-include]
            - [Self-Referential Headers][self-referential-headers]
        - [Dump][dump-1]
    - [Lecture 3: 10 January 2014][lecture-3-10-january-2014]
        - [Pointers Review][pointers-review]
        - [Passing Arrays to Functions][passing-arrays-to-functions]
        - [Copy Constructors][copy-constructors]
    - [Lecture 4: 13 January 2014][lecture-4-13-january-2014]
        - [Pointers Review][pointers-review-1]
            - [Dynamic Variables][dynamic-variables]
            - [Dynamic Class Members][dynamic-class-members]
        - [Namespaces][namespaces]
            - [Creating a Namespace][creating-a-namespace]
            - [Using-directives][using-directives]
            - [Using-declaration][using-declaration]
            - [Qualifying Namespaces][qualifying-namespaces]
        - [Copy Construction][copy-construction]
            - [Syntax][syntax]
            - [Deep Copying][deep-copying]
            - [The Importance of CC's][the-importance-of-ccs]
            - [Dump][dump-2]
        - [Dump][dump-3]
    - [Lecure 4: 14 January 2014][lecure-4-14-january-2014]
        - [Operator Overloading][operator-overloading]
            - [Basics][basics]
            - [Syntax for Overloading a Binary Operator][syntax-for-overloading-a-binary-operator]
                - [Tip: Constructors Returning Objects][tip-constructors-returning-objects]
            - [Returning by const Value][returning-by-const-value]
        - [Overloading the Negation Operator ( - )][overloading-the-negation-operator----]
        - [Overloading Operators as Member Functions][overloading-operators-as-member-functions]
        - [Overloading the Function Call Operator ( () )][overloading-the-function-call-operator---]
        - [Overloading the Assignment Operator ( = )][overloading-the-assignment-operator---]
            - [Syntax][syntax-1]
            - [With Dynamic Memory][with-dynamic-memory]
            - [Multiple Assignments][multiple-assignments]
            - [Anti-Aliasing of Instances][anti-aliasing-of-instances]
        ...
        - [Toss][toss]
    - [Supplementary from Forney Notes #1: 17 January 2014][supplementary-from-forney-notes-1-17-january-2014]
        - [Initializer Lists][initializer-lists-1]
        - [C++ Compilation Process][c-compilation-process]
            - [Preprocessing][preprocessing]
            - [Compilation][compilation]
            - [Linking][linking]
        - [Dump][dump-5]
    - [Lectures 5 & 6: 17 January 2014 & 22 January 2014][lectures-5--6-17-january-2014--22-january-2014]
        - [Review: The Big Three][review-the-big-three]
        - [Linked Lists][linked-lists]
            - [The Problem][the-problem]
            - [A House Analogy][a-house-analogy]
            - [A Train Analogy][a-train-analogy]
        ...
        - [Linked Lists Cheat Sheet][linked-lists-cheat-sheet]
        - [Linked Lists vs. Arrays][linked-lists-vs-arrays]
    - [Discussion #1 with Forney: 24 January 2014][discussion-1-with-forney-24-january-2014]
- [~][~]
    - [Lecture 7: 26 January 2014][lecture-7-26-january-2014]
        - [Inheritance][inheritance]
        - [ShieldedRobot & Student Analogies][shieldedrobot--student-analogies]
            - [Terminology][terminology]
            - [Syntax][syntax-2]
        - [Virtual Member Functions][virtual-member-functions]
            - [Inheritance Function Call Rules][inheritance-function-call-rules]
            - [][]
            - [Inheritance and Construction][inheritance-and-construction]
            - [Inheritance and Member Visibility][inheritance-and-member-visibility]
                - [Protected Members][protected-members]
            - [Recap][recap]
        - [Dump][dump-6]
    - [Lecture 8: 29 January 2014][lecture-8-29-january-2014]
        - [Polymorphism][polymorphism]
            - [Shape Example][shape-example]
            - [Inheritance vs. Polymorphism][inheritance-vs-polymorphism]
            - [The Importance of `Virtual`][the-importance-of-virtual]
            - [Superclass and subclass Pointers][superclass-and-subclass-pointers]
            - [Virtual Destructors][virtual-destructors]
            - [Vtables][vtables]
            - [Summary][summary]
        - [Pure Virtual Functions][pure-virtual-functions]
        - [Abstract Base Classes][abstract-base-classes]
        - [Challenge: Diary Class][challenge-diary-class]
    - [Challenge:][challenge]
        - [Secret Diary Challenge][secret-diary-challenge]
        - [Scrambled Diary Challenge][scrambled-diary-challenge]
    - [Lecture 9: Stacks & Queues][lecture-9-stacks--queues]
        - [][-1]
    - [Lectures 10 & 11: 3 February 2014 & 5 February 2014][lectures-10--11-3-february-2014--5-february-2014]
        - [Recursion][recursion]
            - [Thinking Paradigm Behind Recursion][thinking-paradigm-behind-recursion]
                - ["Lazy Person's Sort"][lazy-persons-sort]
            - [The Two Rules of Recursion][the-two-rules-of-recursion]
            - [Tracing Through Recursion][tracing-through-recursion]
            - [Wielding Recursion][wielding-recursion]
            - [Static Variables][static-variables]
        - [Recursion on Arrays][recursion-on-arrays]
            - [Challenge][challenge-1]
        - [Recursion on a Linked List][recursion-on-a-linked-list]
        - [Be Careful with Recursion][be-careful-with-recursion]
        - [Binary Search][binary-search]
        - [Recursion Binary Search][recursion-binary-search]
        - [Solving Mazes with Recursion][solving-mazes-with-recursion]
    - [Lecture 12: 10 February 2014][lecture-12-10-february-2014]
        - [Review: Recursion][review-recursion]
        - [Generic Programming][generic-programming]
        - [Custom Comparison Operators][custom-comparison-operators]
        - [Templates][templates]
            - [Template Implementation Details][template-implementation-details]
            - [Multi-Type Templates][multi-type-templates]
            - [Generic Classes][generic-classes]
        - [Inline Methods][inline-methods]
        - [STL][stl]
            - [Vector][vector]
            - [Summary of][summary-of]
            - [Summary of][summary-of-1]
                - [List Iteration][list-iteration]
                - [Const Iterators][const-iterators]
            - [Summary of][summary-of-2]
            - [Summary of][summary-of-3]
                - [Iterator Gotchas][iterator-gotchas]
            - [STL Algorithms][stl-algorithms]
                - [find()][find]
                - [find_if()][find_if]
                - [sort()][sort]
            - [Compound STL Data Structures][compound-stl-data-structures]
        - [From Office Hours][from-office-hours]
    - [What happened this day? : 12 February 2014][what-happened-this-day--12-february-2014]
    - [Lecture 13: 19 February 2014][lecture-13-19-february-2014]
        - [Compound STL Data Structures, finished][compound-stl-data-structures-finished]
        - [Big-O Notation][big-o-notation]
        - [Computing Big-O][computing-big-o]
            - [Big-O Examples][big-o-examples]
        - [The STL and Big-O][the-stl-and-big-o]
    - [Lecture 14: 24 February 2014][lecture-14-24-february-2014]
        - [STL's Big-O continued][stls-big-o-continued]
        - [Sorting][sorting]
            - [Rules][rules]
        ...
        - [Shell Sort][shell-sort]
            - [h-shorting][h-shorting]
            - [Shellsort][shellsort]
        - [Dump][dump-7]
    - [Lecture 15: 26 February 2014][lecture-15-26-february-2014]
        - [Quicksort][quicksort]
        - [Mergesort][mergesort]
        - [Trees][trees]
        ...
        - [Binary Tree Traversals][binary-tree-traversals]
            ...
            - [Post-Order Travesal][post-order-travesal]
            - [Level-Order Traversal][level-order-traversal]
            - [Big-O of Traversals][big-o-of-traversals]
        - [Dump][dump-8]
    - [Lecture 16: 3 March 2014][lecture-16-3-march-2014]
        - [Evaluating Expressions][evaluating-expressions]
        - [Binary Search Trees][binary-search-trees]
            - [Searching a BST][searching-a-bst]
            - [Inserting a New Value into a BST][inserting-a-new-value-into-a-bst]
            - [Finding the Min & Max Values in a BST][finding-the-min--max-values-in-a-bst]
            - [Printing out a BST Alphabetically][printing-out-a-bst-alphabetically]
            - [Destructing a BST][destructing-a-bst]
        - [Deletion in a BST][deletion-in-a-bst]
        - [Office Hours][office-hours]
    - [Lecture 17: 6 March 2014][lecture-17-6-march-2014]
        - [Huffman Encoding][huffman-encoding]
            - [Count Frequency][count-frequency]
            - [Build a Huffman Tree][build-a-huffman-tree]
            - [Compression][compression]
            - [Save the Archive][save-the-archive]
            - [Decoding][decoding]
        ...
        - [Closed Hash Table with Linear Probing][closed-hash-table-with-linear-probing]
            - [Deletion][deletion-1]
        - [Open Hash Table][open-hash-table]
        - [Hash Table Efficiency][hash-table-efficiency]
    - [Lecture 18: 10 March 2014][lecture-18-10-march-2014]
        - [Sizing a Hashtable][sizing-a-hashtable]
        - [Hashing Non-Numbers][hashing-non-numbers]
        - [Hash Table vs. BSTs][hash-table-vs-bsts]
        - [Tables][tables]
            - [Hash-Based Indices][hash-based-indices]
        - [ and][-and]
        - [Priority Queue][priority-queue]
        - [Heaps][heaps]
            - [Maxheap][maxheap]
                - [Extracting the Biggest Item][extracting-the-biggest-item]
                - [Adding a Node to the Maxheap][adding-a-node-to-the-maxheap]
                - [Array-Based Implementation][array-based-implementation]
                    - [Extraction with an array-based Heap][extraction-with-an-array-based-heap]
                - [Dump][dump-10]
            - [Dump][dump-11]
        - [Dump][dump-12]
    - [Lecture 19: 12 March 2014][lecture-19-12-march-2014]
        - [Last Day of Class][last-day-of-class]
        - [Adding Node to an Array-based Maxheap][adding-node-to-an-array-based-maxheap]
        - [Big-O of Heap Insertion][big-o-of-heap-insertion]
        - [Heapsort][heapsort]
        - [Introduction to Graphs][introduction-to-graphs]
            - [Adjacency Matrix][adjacency-matrix]
        - [Adjacency List][adjacency-list]
        - [List vs. Matrix][list-vs-matrix]
